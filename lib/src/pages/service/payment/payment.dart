...
class Payment extends StatefulWidget {
  ...
  const Payment(this.state, this.total,
      {super.key, this.grooming, this.veterinary});
              ...
              (index) => Row(
                    children: [
                      ...
                      AppText(
                        ...
                        margin: EdgeInsets.only(left: padding_tiny.left / 2),
                      )
                    ],
                  )),
          Divider(
    ...
    return Scaffold(
        ...
        body: Column(children: [
          ...
          AppScollview(children: [
            ...
            SizedBox(height: padding_small.left),
            CardContainer(
                margin: EdgeInsets.symmetric(horizontal: padding_small.left),
                children: [
